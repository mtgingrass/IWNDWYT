...
class DayCounterViewModel: ObservableObject {
    ...
    // Start a streak with a custom date (for first-time setup)
    ...
    func resetAllData() {
        ...
        // Reset the start date choice flag so user can pick a new date
        AppSettingsViewModel.shared.resetStartDateChoice()
